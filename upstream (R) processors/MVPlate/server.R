...
shinyServer(function(input, output) {
  #defining directory-------
  # outputDir_cmdline <-  "C:\\Users\\jornb\\Documents\\GitHub\\ot2new\\upstream (R) processors\\MVPlate"
  # outputDir_usrGuide <- "C:\\Users\\jornb\\Documents\\GitHub\\ot2new\\upstream (R) processors\\MVPlate"
  # inputTemplate <- "C:\\Users\\jornb\\Documents\\GitHub\\ot2new\\upstream (R) processors\\MVPlate\\MV_InputTemplate.xlsx"
  # sourceDir <- "C:\\Users\\jornb\\Documents\\GitHub\\ot2new\\upstream (R) processors\\Rscript development\\Task update output to same format\\MVsourceFunctions.R"
  # 
