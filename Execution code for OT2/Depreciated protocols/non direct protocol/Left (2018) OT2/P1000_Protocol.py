...
def run(protocol: protocol_api.ProtocolContext):
    #READ
    global fileName #call from global
    ...
    left_pipette.flow_rate.aspirate=aspirateSpeed * 3.3
    left_pipette.flow_rate.dispense=dispenseSpeed * 3.3
