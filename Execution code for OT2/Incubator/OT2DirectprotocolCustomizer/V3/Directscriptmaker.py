    ...
    if event == 'Send':
        ...
        if(values[4] == True):
            try:
                ...
                robot_root = "'root@"
                robot_ip_miep = robot_ip["OT2L"]
                robot_rest = ":/var/lib/jupyter/notebooks/UserInputs'"
                path_robot = robot_root+robot_ip_miep+robot_rest
                ...
                Full_command = scp + OT2_key + " -o StrictHostKeyChecking=no " + file_path + path_robot
            ...
            try:
                ...
                Full_command = scp + OT2_key_right + " -o StrictHostKeyChecking=no " + file_path + path_robot
                completed = subprocess.run(["powershell", "-Command", Full_command], capture_output=True)
                print(completed)
