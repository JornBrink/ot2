...
while True:
    ...
    if event == 'Save':
        ...
        if(simulation == "1"):    
            os.chdir("C://Users//jornb//Documents//GitHub//ot2new//Execution code for OT2//Incubator//OT2DirectprotocolCustomizer//V7")
        else:
        ...
        if(simulation == "1"): #and values[2] == True):
            os.chdir("C://Users//jornb//Documents//GitHub//ot2new//Execution code for OT2//Incubator//OT2DirectprotocolCustomizer//V7//New Direct scripts")
