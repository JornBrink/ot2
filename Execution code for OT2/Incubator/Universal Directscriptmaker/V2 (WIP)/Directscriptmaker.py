...
while True:
    ...
    if event == 'Save':
        ...
        if "" in (experimentname, usrname, date, directscript[0]):
            ...
            protocol = Protocolcustomizer.Protocolctzer(directscriptname, simulation, cmdfilename, pc, brand, filterloc, experimentname, robotname, directscript)
