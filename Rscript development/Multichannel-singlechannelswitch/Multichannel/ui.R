...
shinyUI(
  pageWithSidebar(
    headerPanel("Multiplate MIC Multichannel pipette function- OT2 Commander"),
    
    sidebarPanel(
      #link to home
      actionButton("Home", "Home", width='300px',
                   onclick ="window.open('https://vanhasseltlab.lacdr.leidenuniv.nl/ot2/home')"),
      actionButton("Singlechannel", "Singlechannel", width = '300px',
                   onclick="window.open('https://vanhasseltlab.lacdr.leidenuniv.nl/ot2/home/MVPlate MCP)"),
