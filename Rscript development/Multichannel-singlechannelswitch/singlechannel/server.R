...
shinyServer(function(input, output) {
  ...
  inputTemplate <- "C:\\Users\\jornb\\Desktop\\ot2-main\\MVPlate MCP\\singlechannel" 
  sourceDir <- "C:\\Users\\jornb\\Desktop\\ot2-main\\MVPlate MCP\\singlechannel\\MVsourceFunctions.R"
